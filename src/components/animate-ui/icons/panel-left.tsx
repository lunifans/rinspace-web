...
const animations = {
  default: {
    ...
    line: {
      ...
      animate: { x1: 7, y1: 3, x2: 7, y2: 21, transition: { type: 'spring', damping: 18, stiffness: 200 } },
    },
...
function IconComponent({ size, ...props }: PanelLeftProps) {
  ...
  return (
    <motion.svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <motion.rect width={18} height={18} x={3} y={3} rx={2} variants={variants.rect} initial="initial" animate={controls} />
...
export { animations, PanelLeft, PanelLeft as PanelLeftIcon, type PanelLeftProps };
