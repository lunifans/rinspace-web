...
const animations = {
  default: {
    rect1: { initial: { height: 9 }, animate: { height: 5, transition: { duration: 0.3, ease: 'easeInOut' } } },
    rect2: { initial: { height: 5 }, animate: { height: 9, transition: { duration: 0.3, ease: 'easeInOut' } } },
    rect3: { initial: { height: 9, y: 0 }, animate: { height: 5, y: 4, transition: { duration: 0.3, ease: 'easeInOut' } } },
    rect4: { initial: { height: 5, y: 0 }, animate: { height: 9, y: -4, transition: { duration: 0.3, ease: 'easeInOut' } } },
...
export { animations, LayoutDashboard, LayoutDashboard as LayoutDashboardIcon, type LayoutDashboardProps };
